...
class CreationViewController: UIViewController, UIImagePickerControllerDelegate,
    ...
    UIGestureRecognizerDelegate
{
    ...
    func shareWithFriendsDidTap() {
        let shareSheet = UIActivityViewController(activityItems: ["StickerApp"], applicationActivities: nil)
    ...
    func launchEmail(_ sender: AnyObject) {
        ...
        let messageBody = ""
        let toRecipents = ["example@example.com"]
